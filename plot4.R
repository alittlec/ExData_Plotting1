...
par(mfrow=c(2,2))
#plot1
with(inputData, plot(DateTime,Global_active_power,ylab="Global Active Power",type="l"))
#plot2 voltage
with(inputData, plot(DateTime,Voltage,xlab="datetime",ylab="Voltage",type="l"))
...
#plot4
with(inputData,plot(DateTime,Global_reactive_power,type="l",xlab="datetime"))
dev.off()